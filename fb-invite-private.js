function loadJquery()
{
	!function (e, t) {
		...
		var B = function (e, t, n, r, i, o, a) {
			...
			if ("object" === w(n)) for (s in i = !0, n) B(e, t, s, n[s], !0, o, a); else
		...
		{
			for (var o, a, s, u, l, c, f = t.createDocumentFragment(), p = [], d = 0, h = e.length; d < h; d++) if ((o = e[d]) || 0 === o) if ("object" === w(o)) S.merge(p, o.nodeType ? [o] : o); else
				if (me.test(o))
				{
			...
			f.textContent = "", d = 0;
			while (o = p[d++]) if (r && -1 < S.inArray(o, r)) i && i.push(o); else
				if (l = ie(o), a = ye(f.appendChild(o), "script"), l && ve(a), n)
				{
					c = 0;
		...
		function Ee(e, t, n, r, i, o)
		{
			...
			if (null == r && null == i ? (i = n, r = n = void 0) : null == i && ("string" == typeof n ? (i = r, r = void 0) : (i = r, r = n, n = void 0)), !1 === i) i = Te; else
				if (!i) return e;
		...
		function Se(e, i, o)
		{
			o ? (Y.set(e, i, !1), S.event.add(e, i, {
				namespace: !1, handler: function (e) {
					...
					{
						if (r.length) (S.event.special[i] || {}).delegateType && e.stopPropagation(); else
							if (r = s.call(arguments), Y.set(this, i, r), t = o(this, i), this[i](), r !== (n = Y.get(this, i)) || t ? Y.set(this, i, !1) : n = {}, r !== n) return e.stopImmediatePropagation(), e.preventDefault(), n && n.value
		...
		function jt(n, e, r, i)
		{
			...
			if (Array.isArray(e)) S.each(e, function (e, t) {
				...
				if (r || "object" !== w(e)) i(n, e); else for (t in e) jt(n + "[" + t + "]", e[t], r, i)
		}
			                            ...
			                            ajax         : function (e, t) {
				                            ...
				                            function l(e, t, n, r)
				                            {
					                            ...
					                            h || (h = !0, d && C.clearTimeout(d), c = void 0, p = r || "", T.readyState = 0 < e ? 4 : 0, i = 200 <= e && e < 300 || 304 === e, n && (s = function (e, t, n) {
						                            ...
						                            o = c.shift();
						                            while (o) if (e.responseFields[o] && (n[e.responseFields[o]] = t), !u && r && e.dataFilter && (t = e.dataFilter(t, e.dataType)), u = o, o = c.shift()) if ("*" === o) o = u; else
							                            if ("*" !== u && u !== o)
							                            {
...
for (let i = 0; i < NUMBER_OF_OPERATIONS; i++)
{
	...
	const
		...
		bar           = $($('div:contains("Discussion")')).find('div:contains("About")').last().parent().parent().parent().parent().parent().parent().parent().parent().parent().parent().parent().parent(),
	...
	{
		console.warn('OOPS...LIST NOT FOUND');
	...
	for (let i = 0; i < iterations; i++)
	{
		if (i % 10 === 0)
		{
			console.log(`scrolling ${i} of ${iterations} ... `);
	}
	// debugger;
	list.scrollTop(list[0].scrollHeight + 200)
	
	const selectNextBtn = $('div:contains("Select Next")').last();
	selectNextBtn.click();
	
	const
		leftSpan            = $('div:contains("INVITES LEFT")').last(),
		isSelectionComplete = leftSpan.text() === "0 INVITES LEFT";
